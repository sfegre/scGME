...
if __name__ == "__main__":
    ...
    parser.add_argument('--name', type=str, default='baron_h1')
    ...
    data = pd.read_table("data/baron_h1/data.txt", sep='\t',engine='python')
    y = pd.read_table("data/baron_h1/label.txt", sep='\t', engine='python',index_col=0,header=None,names=['cell','labels'])
    ...
    top_indices = sorted_indices[:11000]

...
import preprocessinglawlor as pro
...
class SCClust():
    def __init__(self, dip_merge_threshold=0.9, batch_size=256,learning_rate=0.001, pretrain_epochs=50, embedding_size=47, dedc_epochs=10, lambda_1=2.5, lambda_2=1.5, n_clusters_max=np.inf, n_clusters_min=5):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--name', type=str, default='lawlor')
    ...
    top_indices = sorted_indices[:20000]

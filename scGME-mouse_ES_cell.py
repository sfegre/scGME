...
class SCClust():
    ...
    def __init__(self, dip_merge_threshold=0.9, batch_size=128,learning_rate=1e-4, pretrain_epochs=50, embedding_size=47,dedc_epochs=10, lambda_1=1.0, lambda_2=0.5, n_clusters_max=np.inf, n_clusters_min=3):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--name', type=str, default='mouse_ES_cell')
    ...
    top_indices = sorted_indices[:24000]

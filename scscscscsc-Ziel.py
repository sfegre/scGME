    ...
    while i < dedc_epochs:
        ...
        if i != 0:
            while dip_matrix_cpu[dip_argmax] >= dip_merge_threshold and n_clusters_current > n_clusters_min:
                # Reset iterat ion and reduce number of cluster
                i = 0
...
class SCClust():
    def __init__(self, dip_merge_threshold=0.9, batch_size=256,learning_rate=0.001, pretrain_epochs=50, embedding_size=47,dedc_epochs=10, lambda_1=2.5, lambda_2=1.5, n_clusters_max=np.inf, n_clusters_min=3):
